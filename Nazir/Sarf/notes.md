...
> **RETIRED 2026-05-30.** All Topic 1.0 content (Sub Topics 1.1-1.7) has been migrated to per-Sub-Topic files under [`topic-1/`](topic-1/). See:
>
> - [`topic-1/README.md`](topic-1/README.md) — Topic 1.0 navigator with per-Sub-Topic status table
> - [`index.md`](index.md) — top-level book navigator
> - [`_planning/architecture-v2.md`](_planning/architecture-v2.md) — split plan (5 approved decisions)
> - [`_planning/phase-1-execution-prompt.md`](_planning/phase-1-execution-prompt.md) — Phase 1 (Sub Topic 1.7) execution playbook
> - [`_planning/phase-2-execution-prompt.md`](_planning/phase-2-execution-prompt.md) — Phase 2 (Sub Topics 1.1-1.6) execution playbook
> - [`_archive/notes-pre-split-2026-05-30.md`](_archive/notes-pre-split-2026-05-30.md) — pre-Phase-1 backup (4985 lines, original monolith)
> - [`_archive/notes-pre-phase2-2026-05-30.md`](_archive/notes-pre-phase2-2026-05-30.md) — post-Phase-1 stub-state backup (3856 lines)
>
> For Topic 2.0 onwards, new content is written directly under `topic-N/sub-topic-N.M.md` per [`_planning/forward-build-workflow.md`](_planning/forward-build-workflow.md). This file (`notes.md`) is no longer a content source and is NOT a validator target for any PDF page.
