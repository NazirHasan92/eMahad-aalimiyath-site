...
### Sub Topic 1.2 — Naye terms (rolling glossary)

> **Combined block lives in `sub-topic-1.1.md`** — Naye terms aur Sabak sawal for Sub Topics 1.1 + 1.2 originally combined in `notes.md` (entries cover Slides 1-13 across both Sub Topics). To preserve the mechanical-migration invariant, the combined block stays intact in `sub-topic-1.1.md`. See [sub-topic-1.1.md → Sub Topic 1.1 + 1.2 — Naye terms (rolling glossary)](sub-topic-1.1.md).

---

### Sub Topic 1.2 — Sabak sawal (khud test karein)

> **Combined block lives in `sub-topic-1.1.md`** — Sabak sawal for Sub Topics 1.1 + 1.2 originally combined in `notes.md`. See [sub-topic-1.1.md → Sub Topic 1.1 + 1.2 — Sabak sawal](sub-topic-1.1.md).
